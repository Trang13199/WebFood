...
namespace Web_food.DAO
{
    public class DAOProduct
    {
        ...
        public bool Add_product(Product product)
        {
            ...
            string sql_Add =
                "INSERT INTO `products` (image, `name`, price, content, type, quantity) VALUES (@image, @name, @price, @content, @type, @quantity)";
        ...
        public bool Update_product(Product product, int id)
        {
            ...
            string sql_update =
                "UPDATE products SET image = @image, name = @name, price = @price, content = @content, type = @type, quantity = @quantity WHERE id = @id";
        ...
        public static bool addProductType(ProductType productType)
        {
            ...
            MySqlConnection connection = dbConnection.ConnectionSql();
            connection.Open();
            string sql = "insert into product_type values (null,@name,@active)";
            MySqlCommand command = new MySqlCommand(sql, connection);
